  ...
  <div class="container" style='margin-top:90px'>
    <div class="row">
      <div class="col-12 mt-5">
        <h2 class="tebal text-center">List Data Latih</h2><br>
        <p class="desc">Berikut ini adalah data latih yang kami gunakan dalam membuat simulasi kemungkinan seorang wanita menderita Diabetes menggunakan metode naive bayes.</p><br>
